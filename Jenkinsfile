        ...
        stage('Deploying App to Kubernetes') {
            steps {
                script {
                    ...
                    bat 'C:\\cygwin64\\bin\\bash -c "/cygdrive/c/cygwin64/bin/ansible-playbook -i localhost, -e kubeconfig=/cygdrive/c/Users/HP/.kube/config deploy_app.yml --connection=local"'
                }
            }
        }
