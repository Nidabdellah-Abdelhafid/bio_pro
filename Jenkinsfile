        ...
        stage('Deploying App to Kubernetes') {
            steps {
                script {
                    ...
                    bat 'C:\\cygwin64\\bin\\bash -c "/cygdrive/c/cygwin64/bin/ansible-playbook -i 127.0.0.1:*, -e kubeconfig=/cygdrive/c/Users/HP/.kube/config deploy_app.yml --connection=local"'
                }
            }
        }
