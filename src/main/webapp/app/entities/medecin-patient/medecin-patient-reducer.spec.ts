...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_MEDECINPATIENT_LIST actions', async () => {
    ...
    it('dispatches FETCH_MEDECINPATIENT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_MEDECINPATIENT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_MEDECINPATIENT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_MEDECINPATIENT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_MEDECINPATIENT actions', async () => {
      const expectedActions = [
        {
