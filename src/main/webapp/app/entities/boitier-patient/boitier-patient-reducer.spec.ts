...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_BOITIERPATIENT_LIST actions', async () => {
    ...
    it('dispatches FETCH_BOITIERPATIENT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_BOITIERPATIENT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_BOITIERPATIENT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_BOITIERPATIENT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_BOITIERPATIENT actions', async () => {
      const expectedActions = [
        {
