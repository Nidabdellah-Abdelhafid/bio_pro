    ...
    <Row>
      <Col md="8">
        ...
        <dl className="jh-entity-details">
          ...
          <dd>{videoEntity.date ? <TextFormat value={videoEntity.date} type="date" format={APP_LOCAL_DATE_FORMAT} /> : null}</dd>
          <dt>
            <span id="duree">
          ...
          <dd>{videoEntity.patients ? videoEntity.patients.id : ''}</dd>
        </dl>
