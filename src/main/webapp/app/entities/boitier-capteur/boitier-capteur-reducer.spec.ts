...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_BOITIERCAPTEUR_LIST actions', async () => {
    ...
    it('dispatches FETCH_BOITIERCAPTEUR actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_BOITIERCAPTEUR actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_BOITIERCAPTEUR actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_BOITIERCAPTEUR actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_BOITIERCAPTEUR actions', async () => {
      const expectedActions = [
        {
