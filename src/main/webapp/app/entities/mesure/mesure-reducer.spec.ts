...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './mesure.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_MESURE_LIST actions', async () => {
    ...
    it('dispatches FETCH_MESURE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_MESURE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_MESURE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_MESURE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_MESURE actions', async () => {
      const expectedActions = [
        {
